...
const Pool = function(config, configMain, callback) {
  ...
  this.setupPrimaryDaemons = function(callback) {
    ...
    _this.primary.daemon = new Daemon(this.config, primaryDaemons);
    _this.primary.payments.daemon = new Daemon(this.config, primaryPaymentDaemon);
  ...
  this.setupAuxiliaryDaemons = function(callback) {
    ...
    // Build Daemon Instances
    _this.auxiliary.daemon = new Daemon(this.config, auxiliaryDaemons);
    _this.auxiliary.payments.daemon = new Daemon(this.config, auxiliaryPaymentDaemon);
